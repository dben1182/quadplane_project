...
def main():
    ...
    performance.deltaTracker.writeDeltaArray('/home/dben1182/Documents/quadplane_project_modified/data/tracking/controlSurfaceTests/findingTrim/deltas.csv')
    performance.stateTracker.writeTotalState('/home/dben1182/Documents/quadplane_project_modified/data/tracking/controlSurfaceTests/findingTrim/TotalState.csv')
    performance.energyTracker.writeCurrent('/home/dben1182/Documents/quadplane_project_modified/data/tracking/controlSurfaceTests/findingTrim/Current.csv')
    performance.energyTracker.writeCompletePower('/home/dben1182/Documents/quadplane_project_modified/data/tracking/controlSurfaceTests/findingTrim/CompletePower.csv')
