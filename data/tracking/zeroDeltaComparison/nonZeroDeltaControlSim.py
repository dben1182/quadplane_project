#Implements the simulation for the nonzero controller
...
from vtol_control_allocation.simultaneousControl.nonlinear_control_allocation_nonZeroDelta import NonlinearControlAllocation
...
def main():
    ...
    while sim_time < SIM.end_time:
        ...
        vtol.update(delta, currentWind)  # propagate the MAV dynamics
    ...
    #writes out the deltas and the state
    ...
    performance.stateTracker.writeTotalState('/home/dben1182/Documents/quadplane_project_modified/data/tracking/controlSurfaceTests/outputs/state.csv')
